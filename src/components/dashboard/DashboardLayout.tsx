...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <aside
        className={cn(
          "h-screen border-r border-white/10 bg-gradient-to-b from-slate-950 to-slate-900/60 backdrop-blur flex flex-col transition-all duration-200",
      ...
      >
        ...
        <div className="p-4 border-b border-white/5 flex items-center justify-between">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold tracking-wide text-white/90">Search Console</span>
          ...
          <Button
            ...
            className={cn("h-8 w-8 text-slate-300 hover:text-white hover:bg-white/5", sidebarCollapsed && "mx-auto")}
          >
            {sidebarCollapsed ? (
        ...
        <div className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/95 backdrop-blur">
          <div className="px-6 py-3 flex items-center gap-3">
            ...
            <Select value={device} onValueChange={(v: any) => setDevice(v)}>
              <SelectTrigger className="h-9 w-[130px] rounded-xl border-white/10 hover:bg-white/5 text-xs">
            ...
            {country !== "ALL" && (
              <Button 
                ...
                className="h-9 rounded-xl border-white/10 hover:bg-white/5 text-xs"
              >
