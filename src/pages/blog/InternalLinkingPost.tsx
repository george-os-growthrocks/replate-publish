  ...
  return (
    <>
      ...
      <BlogPostLayout
        ...
        description="Use queries, clusters, and templates to deploy internal links that move rankings—minus the manual pain."
        categoryBadges={["Content Strategy"]}
        date="October 28, 2025"
        readTime="10 min read"
        tocItems={["The GSC Export Method", "Smart Anchor Text Templates", "Implementation at Scale", "Measuring Impact", "FAQs"]}
      >
        <p className="lead">
        ...
        <p>Track these metrics before and after internal linking:</p>
        <ul>
        ...
        <Card className="not-prose my-12 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 p-8 text-center">
          ...
          <Button asChild size="lg" className="gradient-primary">
            <Link to="/keyword-clustering">
              Try Clustering Tool<ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </Button>
        </Card>
      </BlogPostLayout>
