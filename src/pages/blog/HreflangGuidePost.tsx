  ...
  return (
    <>
      ...
      <BlogPostLayout
        ...
        description="A pragmatic framework for choosing your international URL strategy—with hreflang templates that actually work."
        categoryBadges={["International SEO", "Technical"]}
        date="October 28, 2025"
        readTime="8 min read"
        tocItems={["The Three URL Structures", "Implementing Hreflang Tags", "FAQs"]}
      >
        <p className="lead">
        ...
        <p>Use our <Link to="/free-tools/hreflang-builder">Hreflang Builder</Link> to generate tags. Key rules:</p>
        <ul>
        ...
        <Card className="not-prose my-12 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 p-8 text-center">
          ...
          <Button asChild size="lg" className="gradient-primary">
            <Link to="/free-tools/hreflang-builder">
              Try Hreflang Builder<ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </Button>
        </Card>
      </BlogPostLayout>
