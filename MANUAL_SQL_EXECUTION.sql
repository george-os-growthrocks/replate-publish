-- =======================================================================
-- MANUAL SQL EXECUTION - Enhanced Credit System & Complete Platform Schema
-- =======================================================================
-- Run this SQL in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/YOUR_PROJECT/sql/new
-- =======================================================================

-- PART 1: User Profiles & Activity Log (if not already created)
-- -----------------------------------------------------------------------
...
-- PART 2: Enhanced Subscription Plans
-- -----------------------------------------------------------------------
...
-- PART 4: User Feature Access Table
-- -----------------------------------------------------------------------
...
-- PART 5: Enhance seo_projects table
-- -----------------------------------------------------------------------
ALTER TABLE seo_projects
ADD COLUMN IF NOT EXISTS project_type TEXT DEFAULT 'organic',
ADD COLUMN IF NOT EXISTS credit_budget INTEGER,
...
-- PART 7: AI Overview Rankings Table
-- -----------------------------------------------------------------------
...
-- PART 8: ChatGPT Citations Table
-- -----------------------------------------------------------------------
...
-- PART 9: Answer The Public Queries Cache
-- -----------------------------------------------------------------------
...
-- PART 10: Enhanced Credit Management Functions
-- -----------------------------------------------------------------------
...
-- =======================================================================
-- END OF MANUAL SQL EXECUTION
-- =======================================================================
-- After running this, your platform will have:
-- ✅ Complete credit system with transactions
-- ✅ Individual feature purchase support
-- ✅ Project enhancements (budget, team members)
-- ✅ Free tool rate limiting
-- ✅ AI Overview tracking
-- ✅ ChatGPT citation tracking
-- ✅ Answer The Public caching
